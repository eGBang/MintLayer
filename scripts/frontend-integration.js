 ...
 * This file demonstrates how to integrate Mintlayer with a web frontend
 */

// For React/Vue/Angular applications
export class MintlayerClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new MintlayerClient(provider, contractAddress);
